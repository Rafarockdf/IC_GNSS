...
folders_to_download = ["MGMC","MGJF"]

base_download_dir = r"C:\Users\rafam\OneDrive\Área de Trabalho\PesquisaGNSS\database\dados_gnss"                     # Directory where the file will be saved
local_wget = r"C:\Users\rafam\OneDrive\Área de Trabalho\PesquisaGNSS\EstudoGNSS\wget.exe"  # Location where wget is installed
